...
public:
	...
	//static map<int, vector<Clause>> finalGroupClauses(map<int, vector<Clause>> groupClauses);
	//static map<int, vector<Clause>> sortByNumConstants(map<int, vector<Clause>> groupedClauses);
