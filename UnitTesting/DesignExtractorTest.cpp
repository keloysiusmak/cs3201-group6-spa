...
namespace UnitTesting
{
	...
	public:
		TEST_CLASS_INITIALIZE(setup)
		{
			...
			pkb.insertToTable(STATEMENT_TABLE, 8, { { 6 },{1,2},{3},{ 1 } });
			pkb.insertToTable(STATEMENT_TABLE, 9, { { 7 },{4,5},{6},{ 1 } });
			...
			pkb.insertToTable(STATEMENT_LIST_TABLE, 6, { { 0 },{ 8 },{} });
			pkb.insertToTable(STATEMENT_LIST_TABLE, 7, { { 0 },{ 9 },{} });
